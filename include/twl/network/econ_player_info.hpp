...
namespace twl
{
	...
	class econ_player_info
	{
		...
		econ_player_info(const std::string& id, const std::string& addr,
						 const std::string& name, const std::string& score)
	...
	public:
		...
		const std::string& addr() const noexcept { return m_addr; }

		const std::string& name() const noexcept { return m_name; }

		const std::string& score() const noexcept { return m_score; }
	};
