		...
		public:
			...
			void recv()
			{
				...
				for(;;)
				{
					...
					if(this->timed_out(timeout))
						break;
				}
			}

		private:
			bool timed_out(mlk::ullong timeout) {return mlk::tm::timed_out(m_recv_start, timeout);}
		};
	}
}
